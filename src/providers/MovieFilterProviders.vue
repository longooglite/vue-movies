...
import { BooleanFilter, Filter, FILTER_KEYS, Movie, MultiSelectFilter, NumberFilter, SingleSelectFilter, StringFilter } from '../types/types'
...
const FILTERS: (
    ...
    },
    {
        ...
        active: false,
        value: null,
        options: movies.value.filter((movie: Movie) => movie.decade).map((movie: Movie) => movie.decade as string) ?? [],
    ...
    },
    {
        ...
        active: false,
        value: null,
        options: movies.value.filter((movie: Movie) => movie.country).map((movie: Movie) => movie.country as string) ?? [],
    ...
    },
    {
        ...
        active: false,
        value: null,
        options: movies.value.filter((movie: Movie) => movie.genre).map((movie: Movie) => movie.genre as string) ?? [],
    ...
    },
    {
        ...
        active: false,
        value: null,
        options: movies.value.filter((movie: Movie) => movie.format).map((movie: Movie) => movie.format as string) ?? [],
