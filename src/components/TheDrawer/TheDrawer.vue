...
<template>
    <Teleport to="body">
        <div class="the-drawer" v-show="drawerStore.drawerOpen">
            ...
            <div
                class="the-drawer-content"
                v-if="drawerStore.drawerOpen"
            >
                <EditMovieDrawer
                    v-if="drawerStore.currentDrawerId === DrawerIds.EDIT_MOVIE && drawerStore.drawerOpen" 
                    :movie="editMovieStore.movie"
                />
                <CreateMovieDrawer
                    v-if="drawerStore.currentDrawerId === DrawerIds.CREATE_MOVIE && drawerStore.drawerOpen"
                />
                <SearchMoviesDrawer
                    v-if="drawerStore.currentDrawerId === DrawerIds.SEARCH_MOVIES && drawerStore.drawerOpen"
                />
                <NavigationDrawer
                    v-if="drawerStore.currentDrawerId === DrawerIds.NAVIGATION && drawerStore.drawerOpen"
                />
            </div>
        </div>
    </Teleport>
