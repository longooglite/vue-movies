...
const tmdbSearchProvider = inject(tmdbSearchProviderKey) as TMDBSearchProviderReturn
...
<template>
    <StringInput label="Search" v-model="searchQuery" @update:modelValue="onSearch" />
</template>
<style scoped>
.search-form {
    display: flex;
