...
import { TriStateBooleanEmits, TriStateBooleanProps, TriStateBooleanValues } from '../../types/components/FormComponents/FormComponents'
...
<template>
    <div className="tri-state-boolean-options">
        ...
        >
            <PhRadioButton :weight="model === TriStateBooleanValues.TRUE ? 'fill' : 'regular'" />
        ...
        >
            <PhRadioButton :weight="model === TriStateBooleanValues.FALSE ? 'fill' : 'regular'" />
        ...
        >
            <PhRadioButton :weight="model === TriStateBooleanValues.NULL ? 'fill' : 'regular'" />
