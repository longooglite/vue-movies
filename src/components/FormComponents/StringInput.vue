...
import { StringInputEmits, StringInputProps } from '../../types/components/FormComponents/FormComponents'
...
.string-input-container input::placeholder {
