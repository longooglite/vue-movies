...
const { movies, updateMovie, refetch } = inject(awsMovieProviderKey) as AwsMovieProviderReturn
...
const genre = ref(props.movie.genre ? Array.isArray(props.movie.genre) ? props.movie.genre.join(', ') : props.movie.genre : null)
const watched = ref(props.movie.watched ? TriStateBooleanValues.TRUE : props.movie.watched ? TriStateBooleanValues.FALSE : TriStateBooleanValues.NULL)
